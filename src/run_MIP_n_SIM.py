...
from result_recorder import MIP_n_SIM_write_result
from visualization import MIP_n_SIM_plot_result, plot_type_tuple
...
if __name__ == '__main__':
    ...
    MIP_n_SIM_write_result(MIP_rewards, SIM_rewards, args, all_transitions, context_prob, p, q, result_name = args.name)
    # -------------------------------------------------
    # visualize
    # -------------------------------------------------
    MIP_n_SIM_plot_result(MIP_rewards, SIM_rewards, args, p, q, context_prob=context_prob, result_name = args.name)
